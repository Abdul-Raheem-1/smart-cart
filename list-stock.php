                ...
                <section class="section">
                    <div class="section-header">
                        ...
                        <div class="section-header-breadcrumb">
                            ...
                            <div class="breadcrumb-item">Stock List</div>
                        </div>
                    </div>

                    <div class="section-body">
                        <h2 class="section-title">Stock</h2>
                        <p class="section-lead">Here are all the registered Item's Stock.</p>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-md v_center">
                                                ...
                                                <?php }
                                                if ($res->num_rows == 0) {
                                                    echo "<tr><td colspan='7'><div class='alert alert-danger'>No Stock found!</div></td></tr>";
                                                } ?>
