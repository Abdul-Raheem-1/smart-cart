        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="nav-link" href="list-order.php">Brands</a></li>
                    <li><a class="nav-link" href="list-book.php">Products</a></li>
                    <li><a class="nav-link" href="list-category.php">Categories</a></li>
                    <li><a class="nav-link" href="list-subcategory.php">Stock</a></li>
                    <li><a class="nav-link" href="list-competition.php">Carts</a></li>
                    <li><a class="nav-link" href="list-competition.php">Sales</a></li>
                    <li class="dropdown">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="nav-link" href="list-order.php">Brand</a></li>
                    <li><a class="nav-link" href="list-book.php">Product</a></li>
                    <li><a class="nav-link" href="list-category.php">Category</a></li>
                    <li><a class="nav-link" href="list-competition.php">Cart</a></li>
                </ul>
            </li>
    </aside>
</div>