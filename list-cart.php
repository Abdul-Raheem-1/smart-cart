                ...
                <section class="section">
                    <div class="section-header">
                        ...
                        <div class="section-header-breadcrumb">
                            ...
                            <div class="breadcrumb-item">Carts List</div>
                        </div>
                    </div>

                    <div class="section-body">
                        <h2 class="section-title">Carts</h2>
                        <p class="section-lead">Here are all the registered Carts.</p>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-md v_center">
                                                ...
                                                <?php
                                                $res = $db->get_entities('cart');
                                                while ($row = mysqli_fetch_array($res)) {
                                                ?>
                                                    <tr>
                                                        <td><?= $row["id"] ?></td>
                                                        <td><?= $row["battery_percentage"] ?></td>
                                                        <td><?= $row["status"] ?></td>
                                                ...
                                                <?php }
                                                if ($res->num_rows == 0) {
                                                    echo "<tr><td colspan='7'><div class='alert alert-danger'>No carts found!</div></td></tr>";
                                                } ?>
